...
public class PagesApi
{
    ...
    public async Task<Response<PageModel>> Create(string title, string name, string script, string? summary = null,
        JsonNode? content = null, JsonNode? variables = null,
        string? eyeCatchingImageId = null, PagesCreatePropertiesFontEnum font = PagesCreatePropertiesFontEnum.SansSerif,
    ...
    {
        [EnumMember(Value = "serif")] Serif,
        [EnumMember(Value = "sans-serif")] SansSerif
    }
    ...
    public async Task<Response<EmptyResponse>> Update(string pageId, string title, string name, string script,
        PagesUpdatePropertiesFontEnum font, bool alignCenter, bool hideTitleWhenPinned, string? summary = null,
        JsonNode? content = null, JsonNode? variables = null,
        string? eyeCatchingImageId = null)
    {
        var param = new Dictionary<string, object?>
        {
            { "pageId", pageId },
