	...
	public class UserDetailedModel: IUserDetailedModel
	{
		...
		public static implicit operator UserDetailedNotMeModel(UserDetailedModel userDetailed)
		{
			return new UserDetailedNotMeModel()
			{
				...
				RequireSigninToViewContents = userDetailed.RequireSigninToViewContents,
				MakeNotesFollowersOnlyBefore = userDetailed.MakeNotesFollowersOnlyBefore,
				MakeNotesHiddenBefore = userDetailed.MakeNotesHiddenBefore,
